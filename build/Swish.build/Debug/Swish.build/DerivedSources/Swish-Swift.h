...
#ifndef SWISH_SWIFT_H
#define SWISH_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Swish",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC5Swish11AppDelegate")
...
@class NSCoder;
SWIFT_CLASS("_TtC5Swish23ConfirmationOverlayView")
@interface ConfirmationOverlayView : NSView
- (void)drawRect:(NSRect)dirtyRect;
- (nonnull instancetype)initWithFrame:(NSRect)frameRect OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC5Swish16HighlightingView")
...
@class NSEvent;
SWIFT_CLASS("_TtC5Swish14KeyCaptureView")
...
@class NSWindow;
SWIFT_CLASS("_TtC5Swish26OnboardingWindowController")
@interface OnboardingWindowController : NSWindowController <NSWindowDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC5Swish27SaveProfileWindowController")
@interface SaveProfileWindowController : NSWindowController <NSWindowDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (void)windowWillClose:(NSNotification * _Nonnull)notification;
- (nonnull instancetype)initWithWindow:(NSWindow * _Nullable)window SWIFT_UNAVAILABLE;
...
SWIFT_CLASS("_TtC5Swish24SettingsWindowController")
...
SWIFT_CLASS("_TtC5Swish20StatusItemController")
